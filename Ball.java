...
public class Ball {
     ...
     * @param col The colour of the Ball (Permissable colours are: BLACK, BLUE,
     ...
     * @param l the new layer of this Ball. Higher layer numbers are drawn on
     *     top of low layer numbers.
     */
     ...
     * @param c the new colour of this Ball, as a String value. Permissable
     *     colours are: BLACK, BLUE, CYAN, DARKGREY, GREY, GREEN, LIGHTGREY,
     *     MAGENTA, ORANGE, PINK, RED, WHITE, YELLOW or #RRGGBB.
     */
