 ...
 * This class represents a Rectabgle object. When combined with the GameArena
 * class, instances of the Rectangle class can be displayed on the screen.
 */
public class Rectangle {
     ...
     * @param x The x co-ordinate position of top left corner of the Rectangle
     *     (in pixels)
     * @param y The y co-ordinate position of top left corner of the Rectangle
     *     (in pixels)
     * @param w The width of the Rectangle (in pixels)
     * @param h The height of the Rectangle (in pixels)
     * @param col The colour of the Rectangle (Permissable colours are: BLACK,
     *     BLUE, CYAN, DARKGREY, GREY, GREEN, LIGHTGREY, MAGENTA, ORANGE, PINK,
     *     RED, WHITE, YELLOW or #RRGGBB)
     */
     ...
     *     BLUE, CYAN, DARKGREY, GREY, GREEN, LIGHTGREY, MAGENTA, ORANGE, PINK,
     *     RED, WHITE, YELLOW or #RRGGBB)
     * @param layer The layer this Rectangle is to be drawn on. Objects with a
     *     higher layer number are always drawn on top of those with lower layer
     *     numbers.
     */
    public Rectangle(double x, double y, double w, double h, String col,
                     int layer) {
     ...
     * @param c the new colour of this Rectangle, as a String value. Permissable
     *     colours are: BLACK, BLUE, CYAN, DARKGREY, GREY, GREEN, LIGHTGREY,
     ...
     * @return true of this rectangle is overlapping the rectangle r, false
     *     otherwise.
     */
    public boolean collides(Rectangle r) {
        return (xPosition + width > r.xPosition &&
                xPosition < r.xPosition + r.width) &&
