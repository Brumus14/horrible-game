...
public class Line {
    ...
    private int[] arrowX =
        new int[3]; // Optinal coordinates of an arrowhead on this line (x)
    private int[] arrowY =
        new int[3]; // Optinal coordinates of an arrowhead on this line (y)

    private int layer;               // The layer this line is drawn on
    private String colour = "WHITE"; // The colour of this line
                                     // Permissable colours are:
                                     // BLACK, BLUE, CYAN, DARKGREY, GREY,
                                     // GREEN, DARKGREEN, LIGHTGREY, MAGENTA,
                                     // ORANGE, PINK, RED, WHITE, YELLOW, BROWN
    ...
    /**
     * Defined the size of the arrowhead on this line, as a proportion to the
     * line's width.
    ...
    /**
     * Determines the x-coordinates of the points that form this lines
     * arrowhead.
    ...
    /**
     * Determines the y-coordinates of the points that form this lines
     * arrowhead.
     ...
     * @param col The colour of the Line (Permissable colours are: BLACK, BLUE,
     *     CYAN, DARKGREY, GREY, GREEN, LIGHTGREY, MAGENTA, ORANGE, PINK, RED,
     *     WHITE, YELLOW or ##RRGGBB)
     * @param lay The layer the Line is to be drawn on. Objects with a higher
     *     layer number are always drawn on top of those with lower layer
     *     numbers.
     */
    public Line(double x1, double y1, double x2, double y2, double thickness,
                String col, int lay) {
        width = thickness;
        colour = col;
        layer = lay;
